...
function localizeOwnedUiText(locale: Exclude<LandingLocaleCode, 'en'>, text: UiText): UiText {
  ...
  return {
    ...
    whatsInsideLead: `${renderer} / ${seedData} / README.`,
    renderer,
    seedData,
...
> = {
  zh: make(localizeOwnedUiText('zh', SHARED.zh)),
  'zh-tw': make(localizeOwnedUiText('zh-tw', zhTw)),
